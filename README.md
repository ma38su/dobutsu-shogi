...
収録問題は、持ち駒、成り、駒取り、打ち捨て、取った駒の再利用など、異なる読みのポイントを体験できるよう構成しています。ゲームエンジンで、すべての攻め方の手が王手であること、最終局面が「王手かつ合法な応手なし」であること、手数、初手の一意性を自動検証しています。問題や相手の応手の計算に外部通信は使用しません。
